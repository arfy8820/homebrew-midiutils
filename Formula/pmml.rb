class Pmml < Formula
  desc "This is  the PMML(Practical Music Macro Language) MIDI compiler"
  ...
  def install
    ...
    prefix.install "INSTALL", "INSTALL.j", "README.j"
    share.install "examples"
    (share/"c_lib").mkpath
    (share/"c_lib").install "c_lib/README"
    (share/"comp").mkpath
    (share/"comp").install "comp/ChangeLog", "comp/TODO"
    (share/"comp").install "comp/tests"
    elisp.install "emacs/pmml-mode.el"
    (share/"m2p").mkpath
    (share/"m2p").install "m2p/ChangeLog"
    cd "manual/eng"
